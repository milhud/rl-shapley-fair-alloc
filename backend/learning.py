...
# 2. NeuralBidPredictor: A dummy predictor that “learns” bid adjustments
...
# 3: server with advancede bidding and learning
class Server:
    def __init__(
        self,
        id: int,
        ...
        self.risk_aversion = risk_aversion  # Factor that changes risk sensitivity
    ...
    # increase current load by task load
